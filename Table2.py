...
#
# Description:
# After creating Table we tried to implement the full casino.
# This casino made us change some lines in the Table.py file.
# -------------------------------------------------------------------------------------------------------------------- #
...
class Table(object):
    ...
    def set_bet_amounts(self):
        for customer in self.customers:
            if str(customer) == "ReturningCustomer":
                self.bet_amounts.append(customer.bet_money(self.min_bet))
            else:
                self.bet_amounts.append(customer.bet_money())
    ...
    # def pay_croupier(self):
    #     for croupier in range(self.croupier):
    #         self.commission.append(croupier.calculate_commission(self.gains[0]))
